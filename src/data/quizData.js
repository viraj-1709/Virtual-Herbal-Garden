export const quizQuestions = [
  {
    ...
    "options": [
      ...
      {
        "text": {
          "en": "Aloe Vera (Ghritkumari)",
          "hi": "घृतकुमारी (Aloe Vera)",
          "ta": "கற்றாழை (Aloe)",
          "bn": "ঘৃতকুমারী (Aloe)"
        },
        "isCorrect": false
      },
      {
        "text": {
          "en": "Ashwagandha",
          "hi": "अश्वगंधा (Ashwagandha)",
          "ta": "அமுக்கிரா (Ashwagandha)",
          "bn": "অশ্বগন্ধা (Ashwagandha)"
        },
        "isCorrect": false
      }
    ],
    ...
    "options": [
      {
        "text": {
          "en": "Curcumin",
          "hi": "करक्यूमिन (Curcumin)",
          "ta": "குர்குமின் (Curcumin)",
          "bn": "কারকিউমিন (Curcumin)"
        },
        "isCorrect": true
      },
      {
    ...
    "options": [
      {
        "text": {
          "en": "Homeopathy",
          "hi": "होम्योपैथी (Homeopathy)",
          "ta": "ஹோமியோபதி (Homeopathy)",
          "bn": "হোমিওপ্যাথি (Homeopathy)"
        },
        "isCorrect": true
      },
      {
        "text": {
          ...
          "ta": "ஆயுர்வேதம் (Ayurveda)",
          "bn": "আয়ুর্বেদ (Ayurveda)"
        },
        "isCorrect": false
      },
      {
  ...
  },
  {
    ...
    "options": [
      {
        "text": {
          "en": "Amalaki, Haritaki, Bibhitaki",
          "hi": "आंवला, हरड़, बहेड़ा",
          "ta": "நெல்லிக்காய், கடுக்காய், தான்றிக்காய்",
          "bn": "আমলকী, হরিতকী, বহেরা"
        },
        "isCorrect": true
      },
      {
      ...
      {
        "text": {
          "en": "Ginger, Black Pepper, Pippali",
          "hi": "सोंठ, काली मिर्च, पिप्पली (त्रिकटु)",
          "ta": "சுக்கு, மிளகு, திப்பிலி",
          "bn": "শুঁঠ, গোলমরিচ, পিপুল"
        },
        "isCorrect": false
      },
      {
        "text": {
          "en": "Ashwagandha, Shatavari, Brahmi",
          "hi": "अश्वगंधा, शतावरी, ब्राह्मी",
          "ta": "அசுவகந்தா, தண்ணீர்விட்டான், பிராமி",
